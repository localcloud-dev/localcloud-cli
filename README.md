...
# Deployed.cc | Command Line Interface (CLI)

This repository includes Command Line Interface (CLI) for [Deployed.cc](https://deployed.cc) - the multi-cloud developer-friendly secure Platform as a service (PaaS).
